...
?>
					...
					<li class="post-40 product type-product status-publish has-post-thumbnail product_cat-animals instock taxable shipping-taxable purchasable product-type-simple">
						...
						<?php
            echo as21_product_add_to_cart(array(
                'id' => $like_set_id
            ));
...
function as21_product_add_to_cart($atts)
{
    ...
    if( is_product() || $atts['quantity'] == 6) {$prod_type = 'card'; $min = 6; }
    else { $prod_type = 'set'; $min = 1; }
    ...
    $dop_add_to_cart_class = '';
    if( is_front_page() or is_page("our-cards") ) echo "<div class='as21-add-to-cart-lg'>";
    ...
    echo '<div class="as21-cart-qty-wrap '.$dop_add_to_cart_class.'">';
    ...
    echo '<div class="as21-calc-qty">
     	<div class="minus">-</div>
     	<input type="text" id="quantity_5b3cabd7e2376" class="input-text qty text" step="1" min="'.$min.'" max="" name="quantity" value="'.$min.'" title="Qty" size="2" pattern="[0-9]*" inputmode="numeric" data-prod-type="'.$prod_type.'" disabled>
     	<div class="plus">+</div>
        </div>
     	</div>';

    if( is_front_page() or is_page("our-cards")  ) echo "</div> <!--end .as21-add-to-cart-lg-->";

    // if( is_front_page() ) {
    //     echo '<div class="as21-cart-qty-wrap as21-wrap-btn-cart-qty-lg">
    //             <div class="minus">-</div>
